...
2. Link the `Git repository` to your Daytona Workspace by selecting one of the three provided options:
  ...
  - **Entering a Custom Repository URL**
     ...
     Alternatively, you can enter a custom repository URL manually to find the repository if it is not listed under your Git Provider account or is from an external source.
...
5. Select the [**`Workspace class`**](/usage/workspaces#workspace-classes) to allocate resources for your Workspace.
