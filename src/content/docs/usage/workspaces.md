...
4. Copy the command generated by Dayonta.
...
1. Copy the command generated by Dayonta.
...
Daytona allows you to pin a Workspace, ensuring it is not deleted, even if it is inactive. Administrators can set limits on the number of Workspaces that each user can pin.

This feature is useful for preserving critical development environments that need to be retained for an extended period of time.
