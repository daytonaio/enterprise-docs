...
View the resources usage within your current quota limits by accessing the **`Usage`** page in the dashboard sidebar. You will be presented with metadata specifying the current state of resources, used credits, active Workspaces list and limits. If the usage does not exist for your team, the page will display *No usage found*.