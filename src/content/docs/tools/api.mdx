...
For example, if your deployment is located at `https://daytona.domain.com`, then your API endpoint is in `https://api.daytonaio.domain.com` and documentation is live in `https://api.daytona.domain.com/v3/docs`. In the API documentation, you can find the API endpoint for your deployment in the top right corner of the page.

#### Example
<dl>
<dt>Daytona dashboard URL</dt>
<dd>`https://daytona.domain.com`</dd>
<dt>API Endpoint</dt>
