...
<VscodeNotification notification="Your application running on port 4321 is available" notificationLink="See all forwarded ports"/>
   ...
   :::tip 
   Whoever opens this link will need to sign in to your Daytona dashboard URL to access it.
   :::
</span>

<span class="content-subtitle">
4. **Create shareable link**: In case you forget to click on the popup notification and miss the link, you can click on the `DAYTONA PORTS` after the port is opened locally, and you should see the public address of the port. 
