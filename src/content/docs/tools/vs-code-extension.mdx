...
2. **Click on install**: Click on the <Button text="Install" tool="vscode" type="green"/> on the website from the last step

3. **Continue to VS Code**: Once you click on <Button text="Install" tool="vscode" type="green"/>, the browser will have a popup window showing you "Visual Studio Code is required to install this extension.", if you have everything listed in <a href="#prerequisites">prerequisites</a> choose <Button text='Continue' tool="vscode" type="primary"/>.

4. **Open <Button text="Code" tool="vscode" type="primary"/>**: In the browser, the popup window will ask "marketplace.visualstudio.com wants to open "Code" ", choose <Button text='Open "Code"' tool="vscode" type="primary"/>. Next you will be redirected to VS Code.

5. **Choose <Button text='Install' tool="vscode" type="primary"/>**: On the tab `Extensions: Daytona`, click on the button <Button text='Install' tool="vscode" type="primary"/>.
...
3. **Click <Button text='Install' tool="vscode" type="primary"/>**: On the extension that opened, hit <Button text='Install' tool="vscode" type="primary"/> either on the extension or on the window `Extensions: Daytona`.

</TabItem>
</Tabs>

_Now you should see your Daytona VS Code extension displayed on the left-hand side of VS Code. But when you click on it, nothing is displayed under <Button text="WORKSPACES" tool="vscode" font="bold" type="normal" icon="chevron-down"/>, <Button text="TEAMS" tool="vscode" font="bold" type="normal" icon="chevron-down"/>, <Button text="PROFILES" tool="vscode" font="bold" type="normal" icon="chevron-down"/>, now what?_
...
1. **Sign in to the dashboard and select a workspace**
   ...
   - Visit your Daytona dashboard URL and make sure you are on the <Button tool="daytona" type="primary" icon="daytona-workspace" iconSize="1.2rem" viewBox="0 0 22 22"  text="Workspaces"/> tab. 
   - Select one of the workspaces and click on the <Button icon="daytona-options" tool="daytona" iconSize="1rem"/> icon on it.
   - Under the dropdown menu, select <Button tool="daytona" icon="daytona-browser" text="Open" iconSize="1.2rem" color="gray"/>.
...
<div class="not-content small">
 <details>
  ...
  You will need to do it now by clicking <Button text="Create" icon="daytona-plus" viewBox="0 0 22 22" iconSize="1rem" tool="daytona"/> in the <Button tool="daytona" type="primary" icon="daytona-workspace" viewBox="0 0 20 20" text="Workspaces" iconSize="1rem"/> tab on the Daytona dashboard to import a repository from your Git provider.
</content>
</details>
</div>
...
2. **Configure default code editor and open workspace**
   ...
   - On Daytona dashboard, click on <Button tool="daytona" text="Settings"/> on the left-hand side menu(under the <Button tool="daytona" text="Account" icon="daytona-account" viewBox="0 0 22 22" iconSize="1rem"/> section). Then at the main page, under <Button tool="daytona" text="Default Editor" font="bold"/> section, select <Button tool="daytona" text="VS Code" icon="vscode-logo" viewBox="0 0 128 128" rightIcon="chevron-down-light"/>. 
   - Click on the <Button tool="daytona" type="primary" icon="daytona-workspace" viewBox="0 0 20 20" text="Workspaces" iconSize="1rem"/> tab and select one of the workspaces. On the right side of the workspace, click on the <Button icon="daytona-options" tool="daytona" iconSize="1rem"/> icon and at the dropdown menu, select `Open`. 
   - After you select <Button tool="daytona" icon="daytona-browser" text="Open" iconSize="1.2rem" color="gray"/>, choose <Button tool="daytona" text="VS Code" icon="vscode-logo" viewBox="0 0 128 128" rightIcon="chevron-down-light"/> as your code editor in the popup modal (You may choose others, but in this guide we will need VS Code). And then click on the button <Button tool="vscode" text="Open"/> on the popup window with the title "Open \<your-selected-workspace's-name\>".
...
- **Granting access to Git provider's organisation access**: Organization members can always request that an owner approve access to organization resources for Daytona, and organization owners receive notification of pending requests. For further information, check [here](https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-personal-account-on-github/managing-your-membership-in-organizations/requesting-organization-approval-for-oauth-apps). After you added additional organisation, their
