...
2. **Configure default code editor and open workspace**
   ...
   - Click on the `Workspaces` tab and select one of the workspaces. On the right side of the workspace, click on the `𓈓` icon and at the dropdown menu, select `Open`. 
