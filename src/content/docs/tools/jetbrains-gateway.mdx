...
- **Checking profiles**: Next to the `Profiles:`, click on the dropdown menu, you will see all your available profiles. Note that workspaces are correlated to your Daytona installation(aka profile), if you switch your profile you won't see the same workspace on previously selected profile. 
