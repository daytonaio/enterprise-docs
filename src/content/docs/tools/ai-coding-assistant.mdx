...
description: Information about the AI coding assistant in Daytona.
---

import Keyboard from '@components/Keyboard.astro';

The AI coding assistant provides code suggestions, completions, and chat functionality for your Workspace code editor. The AI coding assistant uses Mistral Codestral to provide code suggestions and completions, and OpenAI ChatGPT to provide chat functionality.

The AI coding assistant is powered by [continue.dev](https://www.continue.dev/), providing the following features:
