...
- For the **application name**, we recommend using your Daytona dashboard URL for easy recognition.
...
- Sign in to your Google Cloud console's **APIs and services** with [this link](https://console.cloud.google.com/apis/dashboard). Or on your Google Cloud console, click on the hamburger menu on the top left side of the page, then select **APIs and services** under the *IAM & Admin* section.
- Click on **OAuth consent screen** on the left side of the page and select **External** in *User Type*. Click on **CREATE**.
- For **App name**, we recommend using your Daytona dashboard URL for easy recognition.
- For **User support email**, use your IT support email. It is for users to contact you with question about their consent.
