...
```
> - These permission scopes will allow us to access authenticated users' email and account details to authenticate users.
...
## Azure
The following section will guide you through how to configure Azure as an identity provider for your Daytona installation. You will need a registered Azure account associated with a registered Azure Active Directory (AAD) tenant. We assume you are familiar with Azure interface and have experience interacting with it.

### Configure Azure in Keycloak
