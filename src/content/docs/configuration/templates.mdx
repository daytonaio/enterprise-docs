...
We will walk through our default templates, the content of each template, how to customise your own templates and 
...
Below is an indexed description of the default templates, their content and repository URLs. The default template index is located in [this repository](https://github.com/daytonaio/samples-index/blob/main/index.json).

<dl>
    <dt>Alpine</dt>
    <dd>
    - Create a workspace using Alpine Linux as base image with Git installed.
    - Includes: 
      1. .devcontainer
        - .devcontainer.json: a configuration file for devcontainer.
        - Dockerfile: a Dockerfile to build the image.
        - library-scripts/common-alpine.sh: a file contains scripts to update and install critical packages within .
      2. README.md: a brief introduction of the template.
    ```json
