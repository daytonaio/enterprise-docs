...
You can build your own template within your organization to suit your development needs. While the installer script lives in your virtual machine, you can edit the file content to customize your template.
