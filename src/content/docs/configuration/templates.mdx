...
You can use [Daytona CLI](/tools/cli) to create workspaces and repositories based on templates. If you haven't installed it yet, you can run the following commands in your terminal:
