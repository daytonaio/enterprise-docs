---
title: Samples
description: Learn how to create and manage templates in Daytona.
sidebar:
  label: Samples
---
...
```sh
https://github.com/daytonaio/samples-index/blob/main/index.json
```
...
```sh
https://github.com/username/samples/blob/main/index.json
```
