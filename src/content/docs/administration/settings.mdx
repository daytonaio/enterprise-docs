...
Daytona provides an option specify whether users can connect to Workspaces using SSH.

Click the toggle button to enable or disable SSH access. Refer to the [Workspace SSH connection](/usage/workspaces#workspace-ssh-connection) section for more information.
