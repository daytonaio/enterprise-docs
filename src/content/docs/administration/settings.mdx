...
Daytona administration settings page provides options to configure various settings and customize your Daytona instance. You can manage [IDEs](#enabled-ides), [Workspace Samples](#workspace-samples), [Workspace Retention Periods](#workspace-retention-period), and [Telemetry](#telemetry) settings.
