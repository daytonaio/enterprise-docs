...
Daytona provides an option to enable or disable team creation. When enabled, users can create teams and invite other users to collaborate on Workspaces.

## Apply Default Quota to Personal Teams Only

Daytona provides an option to apply the default quota to personal teams only. When enabled, the default quota is applied to new personal teams only. When disabled, the default quota is applied to all new teams.
