...
:::note
Adding a new License will overwrite the existing one.
:::
...
After removing the License, Daytona will be deactivated, and you will no longer be able to access its features. To reactivate Daytona, add a new License.