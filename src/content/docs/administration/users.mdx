...
The Owner user role is the highest level of access in Daytona. Owners can manage all resources and perform all administrative tasks, including including managing users, Workspace classes, Identity Providers, settings, and License.
